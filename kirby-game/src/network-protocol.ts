...
export type RoomState={id:string;host:string;epoch:number;fruits:(string|null)[];starAt:number;mill:boolean;locks:Record<string,string>;bugLandings?:Record<string,number[]>;world?:WorldState;log?:LogEntry[];festival?:StarfallState};
