...
export function mazeDistances(walls:boolean[][]){
...
export function farthestMazeCell(walls:boolean[][]){const distances=mazeDistances(walls);return distances.indexOf(Math.max(...distances));}
